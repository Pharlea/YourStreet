...
const mockOccurrences: Occurrence[] = [
  {
    ...
    description: 'Buraco enorme está causando problemas para carros e motocicletas. Já vi vários acidentes acontecendo por aqui.',
  ...
  },
  {
    ...
    description: 'Poste está quebrado desde a semana passada e a rua fica completamente escura à noite.',
    location: 'Av. Principal, Jardim das Acácias',
    date: 'Há 5 horas',
  ...
  {
    id: 3,
    title: 'Acúmulo de lixo na calçada',
    description: 'Lixo acumulado há dias na esquina. Mau cheiro e risco de doenças.',
  ...
  {
    id: 4,
    title: 'Calçada quebrada e perigosa',
    description: 'Calçada completamente destruída. Vários idosos já caíram aqui.',
    location: 'Rua Central, Bairro Alto',
    date: 'Há 1 dia',
    images: ['https://images.unsplash.com/photo-1717185691293-4ecd7072b847?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800'],
    likes: 51,
    comments: 19,
    lat: -23.5605,
    lng: -46.6433,
...
export function MapView() {
  ...
  useEffect(() => {
    ...
    mockOccurrences.forEach((occurrence) => {
      const marker = L.marker([occurrence.lat, occurrence.lng], { icon: yellowIcon })
        .addTo(map);

      // Add popup
      marker.bindPopup(`
        <div style="font-family: sans-serif;">
          <p style="font-weight: 600; margin: 0 0 4px 0; font-size: 14px;">${occurrence.title}</p>
          <p style="color: #6b7280; margin: 0; font-size: 12px;">${occurrence.location}</p>
        </div>
      `);
